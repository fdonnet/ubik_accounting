...
namespace Ubik.Api.Tests.Integration
{
      ...
      IAsyncLifetime
    {
        ...
        {
            //Environment.SetEnvironmentVariable("AuthServer__MetadataAddress", $"http://localhost:8082/realms/ubik/.well-known/openid-configuration");
            //Environment.SetEnvironmentVariable("AuthServer__Authority", $"http://localhost:8082/realms/ubik");
            //Environment.SetEnvironmentVariable("AuthServer__AuthorizationUrl", $"http://localhost:8082/realms/ubik/protocol/openid-connect/auth");
            //Environment.SetEnvironmentVariable("AuthServer__TokenUrl", $"http://localhost:8082/realms/ubik/protocol/openid-connect/token");
