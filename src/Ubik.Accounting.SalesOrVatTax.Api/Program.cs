...
builder.Services.AddScoped<IAccountLinkedTaxRatesQueryService, AccountLinkedTaxRatesQueryService>();
builder.Services.AddScoped<IAccountLinkedTaxRatesCommandService, AccountLinkedTaxRatesCommandService>();
