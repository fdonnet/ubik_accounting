...
namespace Ubik.Security.Api.Features.RolesAuthorizations.Admin.Controller.v1
{
    [ApiController]
    [ApiVersion("1.0")]
    [Route("admin/api/v{version:apiVersion}/[controller]")]
    public class RolesAuthorizationsController(IRolesAuthorizationsAdminCommandsService commandService, IRolesAuthorizationsAdminQueriesService queryService) : ControllerBase
    {
        [HttpGet]
